...
//        startActivity(new Intent(this, MainActivity.class));
        ...
        if (preferences.getPreferenceBoolean(KEY_DATABASE_CREATED)) {
            ...
            if (preferences.getPreferenceInt(KEY_APP_VERSION) == APP_VERSION) {
                ...
                progressBarDatabase = findViewById(R.id.progress_database);
                ...
                String[] questionList = Methods.readFromFile(this, FILE_QUESTION).split("\r\n___;___\r\n");
                ...
                String[] weaponList = Methods.readFromFile(this, FILE_WEAPON).split("\r\n___;___\r\n");
